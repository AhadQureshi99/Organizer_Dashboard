...
const Home = () => {
    ...
    return (
        <>
            {/* <div className=" flex flex-col relative -mt-28  w-[100%] min-h-[140vh]  -z-10 max-lg:-mt-2 max-lg:min-h-auto max-lg:min-h-0   " style={{ borderRadius: '0 50x 50px 0px' }}>
                <div className="landing-bg bg-[#0000006f] w-[100%] min-h-[120vh] flex justify-center items-center max-lg:min-h-0">
                   

                </div>
                <div className=" absolute top-0 -z-20">
                    <img src={bg} alt="" className="landing w-[100%] max-lg:h-[50vh] max-lg:object-cover  " />
                </div> */}
            {/* </div> */}
            <div className="landing -z-50 " >

                <div className="landing-bg bg-[#0000006f] w-[100%]  flex flex-col h-[40rem] justify-center items-center max-lg:min-h-[auto] max-lg:h-[30rem]">
                    ...
                    <div className="flex flex-col justify-center items-center mx-auto   w-[80%] max-lg:w-[100%] max-lg:px-4">
                        ...
                        <div className="flex justify-between   w-[65%] mt-5 max-lg:w-[100%] max-lg:flex-wrap max-lg:mb-16 max-lg:items-center max-lg:justify-center max-lg:text-center max-lg:gap-5 ">
                            <button className="text-xl bg-[#E45352] py-1.5 px-3 text-[#ffffff] font-medium rounded-full cursor-pointer ">All Events</button>
            ...
            <div className="w-[70%] mx-auto flex flex-col justify-center items-center mt-16 gap-5 max-lg:w-[100%] max-lg:px-5 max-lg:mt-[27rem]">
                <div className="flex items-center text-[#E45352] underline gap-2">
                    <h1 className="text-xl font-medium">View all organizers and players</h1>
            ...
            <div className="w-[100%]   mt-[4rem] relative flex flex-col">
                <img src={Featured_bg} alt="" className="Featured_bg   w-[100%] h-[45rem] max-lg:object-cover max-lg:h-[75rem]  " />
                <div className=" Featured_bg absolute top-0 left-0 right-0 bottom-0  flex flex-col bg-[#000000a9] justify-center items-center gap-10 max-lg:h-auto max-lg:bottom-0 max-lg:py-3">
                    <h1 className="text-3xl font-bold text-[white] max-lg:-mt-20 ">Featured</h1>
                    <div className="w-[70%] flex justify-between pb-2 max-lg:w-[100%] max-lg:px-3" style={{ borderBottom: '1px solid white' }}>
                        <p className="text-2xl font-bold text-[#E45352]">Players</p>
                        <p className="text-2xl font-bold text-[white]">Organizer</p>
                        <p className="text-2xl font-bold text-[white]">Events</p>
                    </div>

                    <div className="flex gap-10 justify-center w-[100%] px-16 mt-10 max-lg:flex-wrap max-lg:px-3 max-lg:gap-4  ">
                        {Players.map((data) => (
                            <div key={data.id} className="w-[20%] bg-[#0f0f0fc1] py-10 rounded-lg flex flex-col gap-2 justify-center items-center max-lg:w-[47%] " style={{ border: '1px solid #e45352' }}>
                                <img src={data.Img} alt="" className='rounded-full w-28 ' style={{ border: '1px solid #e45352' }} />
                                ...
                                <p className="text-[white] text-sm">Sport Preference:Foot ball</p>
                    ...
                    <div className="mb-16 flex gap-5">
                        <div className="w-3 h-3 bg-[#e45352] rounded-full"></div>
...
export default Home
export { Award, player, Cycling, Sport, Hire , FaStar }
